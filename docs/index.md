...
_Chainlink VRF V2 gas lane to call requestRandomWords() with unhashed._
...
```solidity
constructor(contract IERC20 _ESE, contract IeeseeMinter _minter, address _feeCollector, contract IRoyaltyEngineV1 _royaltyEngine, struct Ieesee.ChainlinkContructorArgs chainlinkArgs, address _WETH, contract IUniswapV2Router01 _UniswapV2Router, address _OneInchRouter) public
```
...
| ---- | ---- | ----------- |
| _amount | uint256 |  |
| amountOutMin | uint256 | - Min amount of Chainlink that can be received from swap. |
